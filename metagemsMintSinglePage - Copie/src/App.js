...
function App() {
  ...
  const [feedbackBasic, setFeedbackBasic] = useState(`Click buy to mint your Basic Land.`);
  const [mintAmountBasic, setMintAmountBasic] = useState(1);
  const [claimingNftDeluxe, setClaimingNftDeluxe] = useState(false);
  const [feedbackDeluxe, setFeedbackDeluxe] = useState(`Click buy to mint your Deluxe Land.`);
  const [mintAmountDeluxe, setMintAmountDeluxe] = useState(1);
  const [claimingNftSpecial, setClaimingNftSpecial] = useState(false);
  const [feedbackSpecial, setFeedbackSpecial] = useState(`Click buy to mint your Special Land.`);
  const [mintAmountSpecial, setMintAmountSpecial] = useState(1);
  const [claimingNftSupreme, setClaimingNftSupreme] = useState(false);
  const [feedbackSupreme, setFeedbackSupreme] = useState(`Click buy to mint your Supreme Land.`);
  const [mintAmountSupreme, setMintAmountSupreme] = useState(1);
